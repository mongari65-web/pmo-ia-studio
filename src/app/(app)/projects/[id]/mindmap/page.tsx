...
export default function MindMapPage() {
  ...
  async function loadData() {
    ...
    const { data: docs } = await supabase.from('documents')
      .select('content,updated_at').eq('project_id', id).eq('doc_type', 'mindmap')
  ...
  async function generateMindMap() {
    ...
    const prompt = 'Tu es un expert PMI/PMBOK 7. Genere un Mind Map complet pour ce projet.'
      ...
      + ' Reponds UNIQUEMENT avec un JSON valide: {"id":"root","label":"' + (project?.name||'') + '","icon":"target","children":['
      + '{"id":"obj","label":"Objectifs","children":[{"id":"obj1","label":"Objectif principal","notes":"","children":[]},{"id":"obj2","label":"Livrables cles","notes":"","children":[]}]},'
      + '{"id":"scope","label":"Perimetre","children":[{"id":"sc1","label":"IN scope","notes":"","children":[]},{"id":"sc2","label":"OUT scope","notes":"","children":[]}]},'
      + '{"id":"team","label":"Equipe","children":[{"id":"t1","label":"Chef de Projet","notes":"","children":[]},{"id":"t2","label":"Equipe technique","notes":"","children":[]}]},'
      + '{"id":"risks","label":"Risques","children":[{"id":"r1","label":"Risque technique","notes":"","children":[]},{"id":"r2","label":"Risque planning","notes":"","children":[]}]},'
      + '{"id":"planning","label":"Planning","children":[{"id":"p1","label":"Phase 1 Cadrage","notes":"","children":[]},{"id":"p2","label":"Phase 2 Realisation","notes":"","children":[]}]}'
      + ']}'
